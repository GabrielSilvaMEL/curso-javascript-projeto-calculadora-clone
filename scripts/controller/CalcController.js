class CalcController {
    ...
    {
        this.displayCalc = "0"; //o this faz referência ao objeto instanciado  dessa classe
            //this referencia atributos métodos
        var dataAtual; //ISSO É UM ATRIBUTO, é similar a uma variável mas tem mais recursos
